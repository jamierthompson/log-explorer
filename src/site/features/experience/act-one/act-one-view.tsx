 ...
 * clears the whole investigation and starts its run over in place (the
 * store clears and the explorer remounts fresh). */
export function ActOneView() {
  ...
  // re-seeding the explorer from the (now cleared) store.
  return (
    <ActOne
      key={state.runId}
      lines={mockLogs}
