    ...
    <article className={styles.article}>
      <section id="chasing-an-id" className={styles.section}>
        ...
        <p className={styles.body}>
          ...
          were, you’d have to re-filter, re-position, re-start the tail. To see{" "}
          <em>more</em> context, you click again — another tab, another cycle.
          By the time you’ve worked through the incident, you have a fan of
          tabs, each holding a slice of the story, and you’re piecing the
          picture back together by switching between them.
        </p>
        ...
        <p className={styles.body}>
          ...
          carrying state across tabs that the application could have carried for
          you. Every new view loses the investigation’s accumulated context —
          the filter, the rate of new lines arriving, the position you’d
          reached. The rest of the session goes to reconstructing it.
        </p>
      </section>
      ...
      <section id="the-idea" className={styles.section}>
        ...
        <p className={styles.body}>
          ...
          anchor — and the rows around it expand inline, dimmed for contrast so
          the matching lines stay bright. Open a second context further down
          without losing the first. Open a third.
        </p>
      ...
      <section id="what-i-built" className={styles.section}>
        ...
        <p className={styles.body}>
          The logs are mocked, not live. Filtering is three preset chips, not a
          full search system. There are no error or empty or loading states, no
          real connection to anything — and the list renders every line rather
          than virtualizing. That’s deliberate. The interesting problem is what
          happens in the <em>moment</em> of an investigation; the scaling
          problem isn’t it, and the rest can be built around it later.
        </p>
        <p className={styles.body}>
          ...
          recovery happens — and the filter chips correspond to specific moments
          in that story. The investigation needs something to investigate.
        </p>
      </section>
      ...
      <section id="finding-the-real-problem" className={styles.section}>
        ...
        <p className={styles.body}>
          ...
          anchor, and the rows above and below grow out of it smoothly — a
        ...
        <p className={styles.body}>
          ...
          collapses the moment context opens in place. Smooth row reveals don’t
          close that gap any further.
        </p>
        <p className={styles.body}>
          What in-place context <em>does</em> open up is a different problem,
          layered on top of the first. With multiple contexts visible at once in
          a long list, navigation and orientation become the design work. And
          since logs are read by developers, keyboard parity with the mouse
          isn’t a nice-to-have. Both input methods need to feel first-class.
        </p>
        <p className={styles.body}>
      ...
      <section id="the-legend" className={styles.section}>
        ...
        <p className={styles.body}>
          None of that was planned. Each piece arrived as the answer to a small
          problem the last piece had left behind.
        </p>
        ...
        <p className={styles.body}>
          ...
          sketch on a whiteboard. They worked until you scrolled. Once you moved
          inside an expanded context, the anchor went off-screen and the buttons
          went with it. To expand further you scrolled back, hit More, then
          scrolled back again to where you were reading.
        </p>
        <p className={styles.body}>
          The keyboard bindings —{" "}
          <KeycapSequence keys={["Shift", "E"]} decorative={false} /> to expand
          the most-recent context, <Keycap>Esc</Keycap> to close it — didn’t
          have that problem. They worked from the start, and they kept working
          when the anchor was out of view. With both paths available and one
          strictly worse, the buttons had to go. That left a gap for mouse
          users, but the rest of the design wasn’t settled yet, so I kept
          building.
        </p>
        <p className={styles.body}>
          ...
          modal is a reference: open it, find what you need, close it, and act.
          It tells you nothing about what would happen <em>right now</em> if you
          pressed a key.
        </p>
        <p className={styles.body}>
          A <Keycap>?</Keycap> keycap already sat in the top corner with the
          label <em>for all shortcuts</em> — itself a replacement for an earlier
        ...
        <p className={styles.body}>
          ...
          <Keycap>Esc</Keycap> contextually, just to see if the idea was useful.
        </p>
        <p className={styles.body}>
        ...
        <div className={styles.twoColumn}>
          <div className={styles.twoColumnText}>
            <p>
              And the Legend’s shape — small entries arranged in a bar, each one
              labeled with a binding — turned out to also close the gap{" "}
              <strong>More</strong> and <strong>Less</strong> had left. Each
              entry could be a button. A click or a key press would trigger the
              same action.
            </p>
          </div>
        ...
        <p className={styles.body}>
          ...
          row. <em>Clear filter</em> when a filter is active and no contexts are
          open. The toolbar tracks the application’s state, showing only the
          bindings whose action is meaningful right now.
        </p>

        <p className={styles.body}>
          When nothing applies, it falls back to the original <Keycap>?</Keycap>{" "}
          + <em>for all shortcuts</em> — the surface is never empty.
        </p>
        ...
        <p className={styles.body}>
          ...
          expanding, the press did nothing you could see. The action fired, the
          effect happened off-screen, no acknowledgement.
        </p>
        <p className={styles.body}>
          The obvious move was to auto-scroll to where the expansion landed. But
          a context expands in two directions at once — the rows grow above and
          below the anchor — and there’s no single right place to scroll to.
          Every heuristic has a wrong answer somewhere. Yanking the viewport to
          the wrong end is worse than not scrolling at all.
        </p>
        <p className={styles.body}>
        ...
        <div className={styles.twoColumnMirrored}>
          <div className={styles.twoColumnText}>
            <p>
              Each time{" "}
              <KeycapSequence keys={["Shift", "E"]} decorative={false} /> fires,
              the <KeycapSequence keys={["Shift", "E"]} decorative={false} />{" "}
              entry pulses — a 180ms fade, gated behind{" "}
              <code>prefers-reduced-motion</code>. The motion catches the eye in
              peripheral vision: <em>something happened</em>.
            </p>
          </div>
        ...
        <p className={styles.body}>
          ...
          right now, accepts a click as readily as a press, and acknowledges its
          own firings — three roles, each filling a gap the original hint
          hadn’t.
        </p>
      </section>
      ...
      <section id="what-id-do-next" className={styles.section}>
        ...
        <p className={styles.body}>
          ...
          marks, open contexts as highlighted regions, the visible viewport as a
          sliding indicator. When{" "}
          <KeycapSequence keys={["Shift", "E"]} decorative={false} /> expands a
          context fifty lines below your view, the mini-map pulses at that
      ...
      <section id="what-ill-carry-forward" className={styles.section}>
        ...
        <p className={styles.body}>
          <strong>Cut what isn’t doing work.</strong> The animated reveal looked
          great at ten lines. It would have looked great in a portfolio shot. It
          went anyway, because it wasn’t doing the work the prototype needed.
          Polish has a finite budget; the pieces that survive should be the ones
          moving the central idea forward.
        </p>
        <p className={styles.body}>
          ...
          small enough to register in the periphery, quiet enough not to demand
          attention. Whatever I build next, I’ll keep asking where the
          acknowledgement lives.
        </p>
        <p className={styles.body}>
          <strong>Treat keyboard and mouse as equals.</strong> Not redundant
          paths, but parallel ones. Both deserve to feel first-class — and when
          one is added later, the other shouldn’t degrade.
        </p>
      </section>
      ...
      <section id="closing" className={styles.section}>
        ...
        <p className={styles.body}>
          ...
          investigations live in one view, the bindings tell you what they’d do
